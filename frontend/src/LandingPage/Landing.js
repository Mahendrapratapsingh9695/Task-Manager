...
// import CheckIcon from "../Images/123.jpg";
      ...
      <section className="feature gradient">
        ...
        <div className="container" role="complementary">
          <div className="row align-items-center justify-content-center">
            ...
            image from:
            https://www.vecteezy.com/vector-art/227880-female-developer-vector
            <div className="col-md-5">
              <h2 className="my-3">What can OpTask do?</h2>
              <p className="my-4">
                Taskmanager is reimaging how project management can be done. By
